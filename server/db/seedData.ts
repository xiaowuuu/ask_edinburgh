...
const seedData = {
  ...
  questions: [
    {_id: questionId1, userId, questionText:"Is summer the best season of Edinburgh?"},
    {_id: questionId2, userId, questionText:"What are some hidden gems or lesser-known places to visit in Edinburgh that you would recommend to someone visiting for the first time?"},
